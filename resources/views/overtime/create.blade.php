...
<div class="px-4 sm:px-6 lg:px-8">
    <div class="md:grid md:grid-cols-3 md:gap-6">
        <div class="md:col-span-1">
            <h3 class="text-lg font-medium leading-6 text-gray-900">Overtime Record</h3>
            <p class="mt-1 text-sm text-gray-600">
                Add overtime record for <strong>{{ $employee->full_name }}</strong>
            </p>
            ...
            <div class="mt-4 p-4 bg-blue-50 rounded-md">
                <p class="text-xs text-blue-800">
                    <strong>Auto-calculation:</strong> Enter Time IN, Time OUT, and Break hours. The system will automatically calculate Total Hours and OT.
                </p>
            </div>
        </div>
                    ...
                    <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-2">
                                ...
                                <input type="number" name="break_hours" value="{{ old('break_hours', 1) }}" step="0.5" min="0"
                                       placeholder="e.g., 1"
                                       class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                            </div>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="number" name="total_hours_rendered" value="{{ old('total_hours_rendered') }}" step="0.01" min="0"
                                    placeholder="Auto-calculated (min 8 hrs)"
                                ...
                                <p class="mt-1 text-xs text-gray-500">Leave blank for auto-calc (minimum 8 hours)</p>
                            </div>

                            <div class="col-span-6 sm:col-span-3">
                                <label class="block text-sm font-medium text-gray-700">Overtime Hours</label>
                                <input type="number" name="overtime_hours" value="{{ old('overtime_hours') }}" step="0.01" min="0"
                                    placeholder="Auto-calculated"
                                    class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md bg-gray-50">
                                <p class="mt-1 text-xs text-gray-500">Auto-calculated (Total Hours - 8)</p>
                            </div>
                            ...
                            <div class="col-span-6">
                                ...
                                <textarea name="purpose_deliverables" rows="3"
                                          class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">{{ old('purpose_deliverables') }}</textarea>
                            </div>
                            ...
                            <div class="col-span-6">
                                ...
                                <textarea name="actual_accomplishment" rows="3"
                                          class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">{{ old('actual_accomplishment') }}</textarea>
                            </div>
                        </div>
                    </div>
